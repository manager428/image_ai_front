...
export const chatSlice = createSlice({
  ...
  reducers: {
    updateMsgToPlay: (state, action) => {
      return { ...state, error: null, msgToPlay: action.payload  }
    },
...
export const { fetchMessage, fetchMessageSuccess, fetchMessageFailed, updateMsgToPlay } = chatSlice.actions;
